...
| タスク2: 依存関係チェック・最適化 | 🔄 次のステップ | - | peerDependencies整理が必要 |
| タスク3: リリースフロー設計 | ⏳ 未着手 | - | Changesets設定予定 |
...
- `.github/workflows/release.yml`（オプション）
- リリースフロードキュメント
